...
const navItems = [
    ...
    { name: 'Sự kiện', href: '/admin/su-kien', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className={`fixed inset-0 z-40 lg:hidden ${sidebarOpen ? '' : 'hidden'}`}>
                ...
                <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-gradient-to-b from-indigo-800 to-indigo-900">
                    <div className="flex h-16 items-center justify-between px-4">
                        <span className="text-xl font-bold text-white">Đoàn Khoa</span>
            ...
            <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
                <div className="flex flex-col flex-grow bg-gradient-to-b from-indigo-800 to-indigo-900 pt-5 overflow-y-auto">
                    <div className="flex items-center flex-shrink-0 px-6 mb-8">
                        <div className="flex items-center">
                            ...
                            <div className="ml-3">
                                <p className="text-lg font-bold text-white">Đoàn Khoa</p>
                                <p className="text-xs text-indigo-200">Quản lý sự kiện</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 border-t border-indigo-700">
                        <div className="flex items-center">
                            ...
                            <div className="ml-3 flex-1 min-w-0">
                                <p className="text-sm font-medium text-white truncate">{user?.hoTen || 'Admin'}</p>
